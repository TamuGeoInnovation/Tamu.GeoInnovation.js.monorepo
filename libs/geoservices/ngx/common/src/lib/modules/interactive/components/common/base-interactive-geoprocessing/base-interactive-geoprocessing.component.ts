...
export abstract class BaseInteractiveGeoprocessingComponent<ResultType, ParamType> implements OnInit {
  ...
  public mapPoints: Observable<Array<ILatLonPair> | null>;
  ...
  public toggleMode(mode: ComponentMode | null) {
   ...
   */
  private get _cache(): { form: Record<string, unknown>; result: ResultType } | null {
    return this.localStore.getStorageObjectKeyValue({
      primaryKey: this._localStorePrimaryKey,
   ...
   * Returns the cached form and result from local storage.
   */
  private set _cache(c: { form: Record<string, unknown>; result: ResultType } | null) {
    this.localStore.setStorageObjectKeyValue({
      primaryKey: this._localStorePrimaryKey,
      subKey: this._localStoreSubKey,
      value: c
  ...
  public abstract getQuery(): UnaryFunction<Observable<unknown>, Observable<ResultType>>;

  public abstract getMapPoints(): UnaryFunction<Observable<ResultType>, Observable<Array<ILatLonPair> | null>>;
