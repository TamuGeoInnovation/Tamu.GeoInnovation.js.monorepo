...
const ACCESSIBLE_PARKING_ICON_WIDTH = 26;
const ACCESSIBLE_PARKING_ICON_HEIGHT = (ACCESSIBLE_PARKING_ICON_WIDTH * 37.5) / 32;
...
const PARKMOBILE_PREPAID_PARKING_ICON_HEIGHT = (PARKMOBILE_PREPAID_PARKING_ICON_WIDTH * 39) / 32;
