...
export * from './lib/modules/people/people.module';

export * from './lib/modules/modals/entity-actions-modals/entity-actions-modals.module';
...
export * from './lib/pipes/submission-review-status/submission-review-status.pipe';
