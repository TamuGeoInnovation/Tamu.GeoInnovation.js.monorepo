...
export class OpenIdProvider {
  ...
  static async build(clients?: IClientMetadata[], userService?: UserService): Promise<Provider> {
    ...
    return new Promise(async (resolve, reject) => {
      ...
      OpenIdProvider.provider = new Provider('http://localhost:4001', (PROVIDER_CONFIGURATION as unknown) as Configuration);
      // }
      // if (clientService) {
      //   const clients = await clientService.loadClientMetadaForOidcSetup();
      //   if (clients) {
