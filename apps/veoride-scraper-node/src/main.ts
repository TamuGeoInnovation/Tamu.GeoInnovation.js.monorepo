...
import { Trip, StatusChange, DataTask, PersistanceRecord, Vehicle } from '@tamu-gisc/veoride/common/entities';
...
createConnection({
  ...dbConfig,
  entities: [Trip, StatusChange, DataTask, PersistanceRecord, Vehicle]
})
  .then((connection) => {
