          ...
          (e.getRowColCoords = function (t) {
            ...
            (e.getPositions = function (t) {
              for (var r = [], n = e.getRowColCoords(t), o = n.length, i = 0; i < o; i++)
                for (var u = 0; u < o; u++)
                  (0 === i && 0 === u) || (0 === i && u === o - 1) || (i === o - 1 && 0 === u) || r.push([n[i], n[u]]);
              return r;
            });
        },
        { './utils': 21 }
          ...
          (e.isValid = function (t) {
            ...
            (e.getPenaltyN1 = function (t) {
              for (var r = t.size, e = 0, n = 0, i = 0, u = null, a = null, f = 0; f < r; f++) {
                ...
                for (var s = 0; s < r; s++) {
                  var h = t.get(f, s);
                  h === u ? n++ : (n >= 5 && (e += o.N1 + (n - 5)), (u = h), (n = 1)),
                    (h = t.get(s, f)),
                    h === a ? i++ : (i >= 5 && (e += o.N1 + (i - 5)), (a = h), (i = 1));
                }
        ...
        function (t, r, e) {
              ...
              for (var a = t[i], f = [], s = 0; s < a.length; s++) {
                ...
                for (var g = 0; g < o.length; g++) {
                  ...
                  e[p] && e[p].node.mode === h.mode
                    ? ((n[p][l] = u(e[p].lastCount + h.length, h.mode) - u(e[p].lastCount, h.mode)),
                      (e[p].lastCount += h.length))
                    : (e[p] && (e[p].lastCount = h.length),
                      (n[p][l] = u(h.length, h.mode) + 4 + c.getCharCountIndicator(h.mode, r)));
                }
              }
              o = f;
            }
          ...
          function h(t, r) {
            ...
            if ((e = c.from(r, n)) !== c.BYTE && e.bit < n.bit)
              throw new Error(
                '"' + t + '" cannot be encoded with mode ' + c.toString(e) + '.\n Suggested mode is: ' + c.toString(n)
              );
        ...
        function (t, r, e) {
          function n(t, r, e, n, u) {
            ...
            2 === f
              ? ((u = e), (e = r), (r = n = void 0))
              : 3 === f &&
                (r.getContext && void 0 === u ? ((u = n), (n = void 0)) : ((u = n), (n = e), (e = r), (r = void 0)));
            try {
              var h = i.create(e, n);
              u(null, t(h, r, n));
            } catch (t) {
            ...
            for (var n = '', i = 0, u = !1, a = 0, f = 0; f < t.length; f++) {
              ...
              s || u || (u = !0),
                t[f]
                  ? (a++,
                    (f > 0 && s > 0 && t[f - 1]) ||
                      ((n += u ? o('M', s + e, 0.5 + h + e) : o('m', i, 0)), (i = 0), (u = !1)),
        ...
        function (t, r, e) {
          ...
          function c(t, r) {
            ...
            if (r) {
              if (('undefined' != typeof ArrayBuffer && r.buffer instanceof ArrayBuffer) || 'length' in r)
                return 'number' != typeof r.length || i(r.length) ? u(t, 0) : s(t, r);
          ...
          n.TYPED_ARRAY_SUPPORT &&
            ...
            (n.prototype.write = function (t, r, e) {
              ...
              var n = this.length - r;
              if (((void 0 === e || e > n) && (e = n), (t.length > 0 && (e < 0 || r < 0)) || r > this.length))
            ...
            (n.prototype.fill = function (t, r, e) {
              if ('string' == typeof t) {
                if (
                  ('string' == typeof r ? ((r = 0), (e = this.length)) : 'string' == typeof e && (e = this.length),
                  1 === t.length)
                ) {
        ...
        function (t, r, e) {
          ...
          function u(t) {
            ...
            return (
              ...
              1 === a &&
                ((r = (c[t.charCodeAt(e)] << 10) | (c[t.charCodeAt(e + 1)] << 4) | (c[t.charCodeAt(e + 2)] >> 2)),
                (f[s++] = (r >> 8) & 255),
                (f[s++] = 255 & r)),
              f
            );
          ...
          function f(t, r, e) {
            for (var n, o = [], i = r; i < e; i += 3)
              (n = ((t[i] << 16) & 16711680) + ((t[i + 1] << 8) & 65280) + (255 & t[i + 2])), o.push(a(n));
            return o.join('');
          }
          function s(t) {
            for (var r, e = t.length, n = e % 3, o = [], i = 0, u = e - n; i < u; i += 16383)
              o.push(f(t, i, i + 16383 > u ? u : i + 16383));
            return (
              1 === n
                ? ((r = t[e - 1]), o.push(h[r >> 2] + h[(r << 4) & 63] + '=='))
                : 2 === n &&
                  ((r = (t[e - 2] << 8) + t[e - 1]), o.push(h[r >> 10] + h[(r >> 4) & 63] + h[(r << 2) & 63] + '=')),
              o.join('')
            );
          }
        ...
        function (t, r, e) {
          ...
          function O(t, r, e, n, o) {
            return (
              (r = +r),
              (e >>>= 0),
              o || _(t, r, e, 8, 1.7976931348623157e308, -1.7976931348623157e308),
          ...
          (o.prototype.slice = function (t, r) {
            ...
            (o.prototype.writeUInt16LE = function (t, r, e) {
              return (
                (t = +t), (r >>>= 0), e || x(this, t, r, 2, 65535, 0), (this[r] = 255 & t), (this[r + 1] = t >>> 8), r + 2
              );
            }),
            (o.prototype.writeUInt16BE = function (t, r, e) {
              return (
                (t = +t), (r >>>= 0), e || x(this, t, r, 2, 65535, 0), (this[r] = t >>> 8), (this[r + 1] = 255 & t), r + 2
              );
            }),
              ...
              for (var a, f, s, h, c, l, g, p; !u.empty(); ) {
                ...
                for (s in c)
                  c.hasOwnProperty(s) &&
                    ...
                    (g = h + l),
                    (p = i[s]),
                    (void 0 === i[s] || p > g) && ((i[s] = g), u.push(s, g), (o[s] = f)));
              }
                  ...
                  isNaN(r) || r === 1 / 0
                    ...
                    : ((u = Math.floor(Math.log(r) / Math.LN2)),
                      ...
                      u + c >= h
                        ...
                        : ((a = r * Math.pow(2, c - 1) * Math.pow(2, o)), (u = 0)));
                o >= 8;
