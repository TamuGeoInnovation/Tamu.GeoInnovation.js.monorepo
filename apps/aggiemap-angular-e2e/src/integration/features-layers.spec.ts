...
desktopSizes.forEach((size) => {
  describe(`Test Layers, Feature Page: ${size} Resolution`, function () {
    ...
    it('Points of Interest', function () {
      ...
      cy.get(':nth-child(7) > .layer-item > :nth-child(1)').trigger('mouseover').click().should('be.visible');
      cy.wait('@POI');
    ...
    it('Restrooms', function () {
      ...
      cy.get(':nth-child(6) > .layer-item > :nth-child(1)').trigger('mouseover').click().should('be.visible');
      cy.wait('@restrooms');
    ...
    it('Lactation Rooms', function () {
      ...
      cy.get(':nth-child(5) > .layer-item > :nth-child(1)').trigger('mouseover').click().should('be.visible');
      cy.wait('@lactation');
    ...
    it('Visitor Parking', function () {
      ...
      cy.get(':nth-child(4) > .layer-item > :nth-child(1)').trigger('mouseover').click().should('be.visible');
      cy.wait('@visitor');
    ...
    it('Accessible Entrances', function () {
      ...
      cy.get(':nth-child(3) > .layer-item > :nth-child(1)').trigger('mouseover').click().should('be.visible');
      cy.wait('@accessible');
    ...
    it('Emergency Phones', function () {
      ...
      cy.get(':nth-child(2) > .layer-item > :nth-child(1)').trigger('mouseover').click().should('be.visible');
      cy.wait('@emergency');
