...
desktopSizes.forEach((size) => {
  describe(`Test Route: ${size} Resolution`, () => {
    ...
    describe('Walk Route Data', () => {
      ...
      it('Directions', () => {
        cy.get('.directions-container').should('contain', 'Sidewalk');
    ...
    describe('Bike Route Data', () => {
      ...
      it('Directions', () => {
        cy.get('.directions-container').should('contain', 'Sidewalk');
        cy.get(':nth-child(2) > tamu-gisc-trip-planner-mode-switch > .mode-icon').should('contain', 'directions_bike');
      });
    });
    describe('Car Route Data', () => {
      ...
      it('Directions', () => {
        ...
        cy.get(':nth-child(2) > tamu-gisc-trip-planner-mode-switch > .mode-icon').should('contain', 'directions_car');
      });
    });
    describe('Bus Route Data', () => {
      ...
      it('Directions', () => {
        cy.get('.directions-container');
        cy.get(':nth-child(2) > tamu-gisc-trip-planner-mode-switch > .mode-icon').should('contain', 'directions_bus');
      });
    });
  });
});
