...
mobileSizes.forEach((size) => {
  describe(`Test Elements on Mobile Layers Page: ${size} resolution`, function () {
    ...
    it('Points of Interest', function () {
      ...
      // checks if popup is visible
      cy.wait(2000);
      cy.get('tamu-gisc-feature-mobile-popup').should('be.visible').and('contain.text', 'Fish Pond');
    ...
    it('Restrooms', function () {
      ...
      // checks if popup is visible
      cy.wait(2000);
      cy.get('tamu-gisc-feature-mobile-popup').should('be.visible').and('contain.text', 'Unisex Restroom');
    });
    ...
    it('Lactation Rooms', function () {
      ...
      // checks if popup is visible
      cy.wait(2000);
      cy.get('tamu-gisc-feature-mobile-popup').should('be.visible').and('contain.text', 'Lactation Room');
      cy.get('.popup').move({ x: 0, y: -415, position: 'center', force: true });
    ...
    it('Visitor Parking', function () {
      ...
      if (size[0] === 375) {
        ...
        cy.wait(2000);
        cy.get('canvas').click(105, 210);
      }
      // checks if popup is visible
      cy.wait(2000);
      cy.get('tamu-gisc-feature-mobile-popup').should('be.visible').and('contain.text', 'Visitor Parking Kiosk');
    });
    ...
    it('Accessible Entrances', function () {
      ...
      // checks if popup is visible
      cy.wait(2000);
      cy.get('tamu-gisc-feature-mobile-popup').should('be.visible').and('contain.text', 'Accessible Entrance');
    });
