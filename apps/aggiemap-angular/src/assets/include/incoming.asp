<head>
  ...
  <meta
    name="keywords"
    content="about, tamu, aggiemap, aggie, map, texas a&m, a&m, tamu campus, texas a&m campus, a&m campus, feedback"
  />
...
ObjSendMail.Cc = "bradzone@tamu.edu;edher@tamu.edu;dan@tamu.edu"
...
<script>
  ...
  setInterval(function () {
    ...
    if (timer === 0) {
      // Once counter hits 0 seconds, redirect to aggiemap
      window.location = '../';
    }
