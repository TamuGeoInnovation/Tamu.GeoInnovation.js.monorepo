...
import { GRADUATION_LAYERS } from '@tamu-gisc/ts/events/ngx';

import { Popups as EventPopups } from '@tamu-gisc/ts/events/ngx';
...
export const Connections = {
  ...
  graduationUrl: 'https://gis.tamu.edu/arcgis/rest/services/TS/GraduationMuster/MapServer'
};
...
export const Definitions = {
  ...
  GRADUATION_TRAFFIC_FLOW: {
    ...
    url: `${Connections.graduationUrl}/1`
  },
  GRADUATION_LINE_PAINT: {
    ...
    url: `${Connections.graduationUrl}/2`
  },
  GRADUATION_CONSTRUCTION: {
    ...
    url: `${Connections.graduationUrl}/3`
  },
  GRADUATION_EVENT_PARKING_LOTS: {
    ...
    url: `${Connections.graduationUrl}/4`
  },
  GRADUATION_ROAD_CLOSURES: {
    ...
    url: `${Connections.graduationUrl}/7`
  }
};
...
export const ColdLayerSources: LayerSource[] = [
  {
    type: 'feature',
    id: Definitions.GRADUATION_TRAFFIC_FLOW.id,
    title: Definitions.GRADUATION_TRAFFIC_FLOW.name,
    url: Definitions.GRADUATION_TRAFFIC_FLOW.url,
    popupComponent: EventPopups.MarkdownPopupComponent,
    popupData: {
  ...
  {
    type: 'feature',
    id: Definitions.GRADUATION_LINE_PAINT.id,
    title: Definitions.GRADUATION_LINE_PAINT.name,
    url: Definitions.GRADUATION_LINE_PAINT.url,
    popupComponent: EventPopups.MarkdownWDirectionsPopupComponent,
    popupData: {
      name: 'attributes.LotName',
  ...
  {
    type: 'feature',
    id: Definitions.GRADUATION_CONSTRUCTION.id,
    title: Definitions.GRADUATION_CONSTRUCTION.name,
    url: Definitions.GRADUATION_CONSTRUCTION.url,
    popupComponent: EventPopups.MarkdownWDirectionsPopupComponent,
    popupData: {
      name: 'attributes.LotName',
      description: 'attributes.Note'
  ...
  {
    type: 'feature',
    id: Definitions.GRADUATION_EVENT_PARKING_LOTS.id,
    title: Definitions.GRADUATION_EVENT_PARKING_LOTS.name,
    url: Definitions.GRADUATION_EVENT_PARKING_LOTS.url,
    popupComponent: EventPopups.MarkdownWDirectionsPopupComponent,
    popupData: {
      name: {
  ...
  {
    type: 'feature',
    id: Definitions.GRADUATION_ROAD_CLOSURES.id,
    title: Definitions.GRADUATION_ROAD_CLOSURES.name,
    url: Definitions.GRADUATION_ROAD_CLOSURES.url,
    popupComponent: EventPopups.MarkdownWDirectionsPopupComponent,
    popupData: {
